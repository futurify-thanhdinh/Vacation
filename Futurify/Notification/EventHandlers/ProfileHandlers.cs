...
{
    public class ProfileHandlers : IMessageHandle<AccountCreatedForEmail>
    {
        ...
        public ProfileHandlers(IBusClient busClient, IHostingEnvironment env, IOptions<ConfigSendEmail> configSendMail, DbContextOptions<Models.MessageContext> context)
        {
